...
main_store = Market.create(
    name: "Beyond the Blend Market", 
    description: "Small Farmer's Market located in NE Pa - did we mention we are indoors a local coffee shop named: A Perfect Blend!"
)

main_store.products.build(
